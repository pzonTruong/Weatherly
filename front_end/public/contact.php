...
<head>
  ...
  <link rel="icon" href="/Weather-app/front_end/src/assets/images/ico/world_phonereceiver.ico" type="image/x-icon">
</head>
...
<body>
  ...
  <section class="flex-1 px-6 py-10">
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg p-8">
        ...
        <form action="#" method="POST" class="space-y-5">
          ...
          <div>
            ...
            <textarea rows="5" placeholder="Write your message here..."
              class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none"></textarea>
          </div>
          <button type="submit"
      ...
      <!-- Contact Info -->
      <div class="space-y-6">
        <h3 class="text-2xl font-bold text-blue-700 mb-6">Get in Touch</h3>
        <p class="text-gray-600">You can also reach out to us via the following channels:</p>
        <div class="space-y-4">
          <div class="flex items-center space-x-3">
            <i class="fas fa-envelope text-blue-600 text-xl"></i>
            <span class="text-gray-700">support@weatherly.com</span>
          </div>
          <div class="flex items-center space-x-3">
          ...
          <div class="flex items-center space-x-3">
            ...
            <span class="text-gray-700">Hanoi, Vietnam</span>
          </div>
        </div>

        <h3 class="text-xl font-bold text-blue-700 mt-8">Follow Us</h3>
        <div class="flex space-x-5 text-2xl mt-3">
          <a href="https://www.facebook.com" class="hover:text-blue-600" title="Facebook"><i
              class="fab fa-facebook"></i></a>
          <a href="https://x.com/PzonTruong" class="hover:text-blue-500" title="Twitter"><i
              class="fab fa-twitter"></i></a>
          <a href="https://github.com/pzonTruong" class="hover:text-gray-700" title="Github"><i
